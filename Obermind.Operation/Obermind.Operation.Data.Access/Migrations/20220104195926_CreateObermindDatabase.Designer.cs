...
namespace Obermind.Operation.Data.Access.Migrations
{
    ...
    [Migration("20220104195926_CreateObermindDatabase")]
    partial class CreateObermindDatabase
    {
            ...
            modelBuilder.Entity("Obermind.Operation.Data.Model.PurchaseOrders.ListItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 1000m,
                            CreatedAt = new DateTime(2022, 1, 5, 0, 59, 26, 126, DateTimeKind.Local).AddTicks(9108),
                            IsDeleted = false,
                            Name = "D1 - List Item",
                        ...
                        new
                        {
                            ...
                            Amount = 200m,
                            CreatedAt = new DateTime(2022, 1, 5, 0, 59, 26, 128, DateTimeKind.Local).AddTicks(498),
                            IsDeleted = false,
                            Name = "D2 - List Item",
                            POId = "491E44F7-12DA-4470-95BA-D6B01ACBB45A",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            ...
                            Amount = 200m,
                            CreatedAt = new DateTime(2022, 1, 5, 0, 59, 26, 128, DateTimeKind.Local).AddTicks(554),
                            IsDeleted = false,
                            Name = "D3 - List Item",
            ...
            modelBuilder.Entity("Obermind.Operation.Data.Model.PurchaseOrders.PurchaseOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            POId = "491E44F7-12DA-4470-95BA-D6B01ACBB45A",
                            Amount = 1200m,
                            CreatedAt = new DateTime(2022, 1, 5, 0, 59, 26, 136, DateTimeKind.Local).AddTicks(9195),
                            IsDeleted = false,
                        ...
                        new
                        {
                            POId = "AD8D7916-EE72-4438-9C5E-90B03EC98857",
                            Amount = 200m,
                            CreatedAt = new DateTime(2022, 1, 5, 0, 59, 26, 137, DateTimeKind.Local).AddTicks(361),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Obermind.Operation.Data.Model.Security.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Adil",
                            Password = "$2a$11$JUn0iZxm5G23SnOUQSbaIeLrYHxnwrwppRzYaKig3LizUCGvlZpT.",
                            Username = "tab"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Purchase",
                            Password = "$2a$11$5bvNNs.8fUBTd6XYQMXQXeUhMJgYfuON5u/QgAgnNmRk8Zj71/SXW",
                            Username = "official"
                        });
                });
